...
export const PREREGISTER_CONTENT: Record<string, PreRegisterContent> = {
  ...
  "path-of-exile-2": {
    ...
    businessModel: "Gratis con suscripción opcional de 15 $/mes (mercado y comercio)",
  ...
  "aion-2": {
    description: [
      ...
      "El PvP escala desde arenas pequeñas hasta asedios Reino contra Reino entre servidores. El juego ya se lanzó en Corea del Sur y Taiwán (noviembre de 2025) y el lanzamiento global ya tiene fecha: acceso anticipado el 30 de septiembre de 2026 para quienes compren un Founder's Pack, y apertura gratuita el 5 de octubre en Steam y PURPLE.",
    ],
    highlights: [
      ...
      "Ya lanzado en Corea del Sur y Taiwán (nov. 2025); global el 5 de octubre de 2026, con acceso anticipado desde el 30 de septiembre.",
      "Personalización de personaje profunda, con cosméticos, tintes y mascotas coleccionables.",
      "Ojo con el modelo: se juega gratis, pero el mercado, el intercambio entre jugadores y el cambio de monedas piden la suscripción de 15 $ al mes. El acceso anticipado del 30 de septiembre también es de pago (pack de fundador).",
    ],
    developer: "NCSoft",
    publisher: "NCSoft",
    platforms: ["PC", "iOS", "Android"],
    businessModel: "Gratis con suscripción opcional de 15 $/mes (mercado y comercio)",
    engine: "Unreal Engine 5",
    releaseWindow: "Acceso anticipado 30 sept. 2026 · apertura global 5 oct. 2026",
