      ...
      bloques: [
        {
          ...
          filas: [
            [{ es: "Arma", en: "Weapon" }, { es: "Hoja de extinción de Ludra", en: "Ludra's Blade of Extinction" }, { es: "20,9", en: "20.9" }, { es: "Mandoble del Rey Dragón Némesis brillante", en: "Splendent Nemesis Dragon Lord Greatsword" }],
            [{ es: "Secundaria", en: "Off-hand" }, { es: "Guarda del Rey Dragón Cornudo", en: "Horned Dragon Lord Guard" }, { es: "29,9", en: "29.9" }, { es: "Guarda del Rey Dragón Cornudo brillante", en: "Splendent Horned Dragon Lord Guard" }],
            [{ es: "Armadura (las seis piezas)", en: "Armour (all six pieces)" }, { es: "Conjunto de la Sombra desvaída", en: "Faded Shadow set" }, { es: "40 – 53", en: "40 – 53" }, { es: "Conjunto del Corazón de lava", en: "Lava Heart set" }],
            [{ es: "Brazalete", en: "Bracelet" }, { es: "Brazalete de la Sombra desvaída", en: "Faded Shadow Bracelet" }, { es: "52,0", en: "52.0" }, { es: "Brazalete de Ludra", en: "Ludra's Bracelet" }],
            [{ es: "Broche", en: "Brooch" }, { es: "Broche de Kaldrix", en: "Kaldrix Brooch" }, { es: "49,0", en: "49.0" }, { es: "Broche del Libertador", en: "Liberator Brooch" }],
            [{ es: "Cinturón", en: "Belt" }, { es: "Cinturón noble", en: "Noble Belt" }, { es: "100", en: "100" }, { es: "— no hay debate", en: "— no debate" }],
