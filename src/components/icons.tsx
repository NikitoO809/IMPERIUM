// Iconos en SVG propios — sin dependencias externas.
// Heredan el color del texto (currentColor) y aceptan className.
...
export function PawIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden {...props}>
      ...
      <path d="M12 11c-2.5 0-4.5 1.8-4.5 4 0 1.7 1.3 3 3 3 .9 0 1.1-.4 1.5-.4s.6.4 1.5.4c1.7 0 3-1.3 3-3 0-2.2-2-4-4.5-4Z" />
    </svg>
  );
}
...
export function DragonIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden {...props}>
      <path d="M2 12c3-1 5-1 7 1 1-3 3-5 7-5 3 0 6 2 6 5 0 4-4 6-8 6-5 0-9-3-12-7Z" />
      <path d="M16 9h.01" />
    </svg>
  );
}
...
export function GemIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden {...props}>
      <path d="M6 3h12l4 6-10 12L2 9Z" /><path d="M2 9h20M9 3 6 9l6 12 6-12-3-6" />
    </svg>
  );
}
...
export function GiftIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden {...props}>
      ...
      <path d="M12 8S10 2 7 4c-2 1.3 0 4 5 4Zm0 0s2-6 5-4c2 1.3 0 4-5 4Z" />
    </svg>
  );
}
