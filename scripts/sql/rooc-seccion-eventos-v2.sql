...
Todavía no hay fecha de inscripción confirmada ni un reglamento oficial completo publicado, así que lo mejor es seguir los canales oficiales del juego para enterarte en cuanto se anuncie.', 'https://gamingph.com/2026/07/a-million-eyes-on-the-action-million-dollar-tyr-cup-s1-concludes-in-spectacular-fashion/', false, array[]::text[], '{}'::jsonb),
    (v_section, 7, 'Bienvenida al servidor: preinscripción con montura y premios', 'Cada vez que ROOC estrena un servidor nuevo, el estudio organiza un evento de preinscripción con recompensas que se van desbloqueando según crece el número de apuntados. El mismo patrón que ya se vio en Asia se repitió para el lanzamiento del servidor Americas, con predescarga el 22 de julio y estreno oficial a las 09:00 del 23 de julio de 2026.

Quien se preinscribe pronto consigue la montura Grupo de Conejos, una fila de conejitos blancos que acompaña al personaje desde el primer día. A partir de ahí, cada nueva meta de preinscripciones alcanzada desbloquea una recompensa más para todos los apuntados.

En paralelo corrió el evento Let''s GOAL, ROOC! — en la línea del Carnaval del Fútbol que ROOC ya había activado durante la beta cerrada de junio, aprovechando la fiebre del Mundial 2026 —: invitar amigos a preinscribirse da un atuendo de temática futbolera, y entre los participantes se repartieron hasta 3.000 dólares en efectivo y varias tarjetas regalo de Google Play, asignados por orden de llegada.', 'https://www.elbotona.com/ragnarok-origin-classic-pase-mensual-lanzamiento-julio/', false, array['https://file.joymaker.com/game/rooc/web/roocam-share2.png']::text[], '{}'::jsonb),
    (v_section, 8, 'La cuenta atrás al lanzamiento: un calendario de micro-retos', 'Además de la preinscripción, ROOC organizó una semana de micro-eventos previos al estreno del servidor Americas: un calendario diario de tareas de comunidad, cada una con su propia recompensa, anunciado por el canal oficial de Facebook LATAM como regalo de bienvenida.

El 11 de julio arrancaron dos retos a la vez: invitar amigos a unirse al Discord oficial desbloqueaba el atuendo Vuelta al Colegio, y reservar en el sitio web oficial daba acceso a accesorios exclusivos. El calendario seguía sumando fechas después del 11 de julio.

Esta fórmula — microtareas ligadas a Discord, redes y el sitio oficial, reunidas en un calendario con recompensa propia en cada casilla — es la que usa ROOC para calentar motores antes de cada lanzamiento de servidor o región nueva, así que conviene estar pendiente de sus redes oficiales en los días previos a cualquier estreno futuro.', 'https://www.facebook.com/RagnarokOriginClassicLATAM/posts/rooc-se-lanzará-el-23-de-julio-para-todos-los-trotamundos-antes-de-entrar-oficia/122114135055294573/', false, array[]::text[], '{}'::jsonb),
    (v_section, 9, 'Menos rutina diaria: la filosofía de ROOC día a día', 'A diferencia de otras versiones móviles de Ragnarok, ROOC no está pensado para obligar a conectarse a horas concretas ni a completar una lista larga de tareas cada noche. Según ha explicado el propio estudio, el juego recorta aproximadamente a la mitad sus actividades diarias y semanales, y simplifica los eventos nocturnos frente a lo habitual en el género.

La idea declarada es quitar presión de conexión constante: menos eventos obligatorios por la noche y menos tareas que conviertan el progreso diario en una obligación. Es la misma filosofía que aplica el juego a su modelo de pagos: nada de gacha, mascotas de nivel S ni atuendos con estadísticas — el Pase Mensual es la única vía de pago que influye en el progreso, y hasta ese pase se puede conseguir jugando (ver el bloque siguiente).

Esto no quiere decir que ROOC no tenga rutina diaria — la tiene, como cualquier Ragnarok — pero el propio estudio la presenta como uno de sus argumentos frente a la competencia: menos presión, mismo espíritu clásico.', 'https://neutralgame.com.mx/ragnarok-origin-classic-america-23-julio/', false, array[]::text[], '{}'::jsonb),
    (v_section, 10, 'El Pase Mensual: la recompensa que se renueva cada mes', 'El Pase Mensual es el único sistema de pago de ROOC que influye en el progreso del personaje, y también funciona como el motor de recompensas recurrentes del juego: cada mes trae su propio tocado (headgear) exclusivo, así que mantenerlo activo cambia el look del personaje una vez al mes sin comprar nada aparte.

Además del tocado, el Pase Mensual desbloquea el modo aventura completo y permite regalar a otros jugadores tanto la Tarjeta MVP como el propio tocado del mes, en vez de quedarse solo en la propia cuenta.

La parte más relevante para quien no quiere pagar: manteniéndose activo en el juego se ganan monedas de oro que se pueden canjear directamente por el Pase Mensual, así que es posible acceder a estas recompensas mensuales jugando sin gastar dinero real — el propio estudio lo describe como su forma de "eliminar por completo la barrera de pago".', 'https://play.google.com/store/apps/details?id=com.gravity.rooc.android&hl=es', false, array[]::text[], '{}'::jsonb),
    (v_section, 11, 'Grandes actualizaciones, su propio evento: Sombras sobre Glast Heim', 'Cuando ROOC estrena una actualización de contenido grande, no llega sola: viene acompañada de un evento de recompensas propio que se extiende varias semanas. El ejemplo más reciente, ya activo en el servidor de Asia (que lleva más tiempo rodando que Americas), es la expansión Sombras sobre Glast Heim, con un mapa nuevo, un capítulo de historia inédito, la clase Pistolero y la mazmorra en equipo Cataclismo Dracónico.

Junto a la expansión arrancó el Mes de la Tormenta de Recompensas: un evento que reparte premios semana a semana durante todo el mes, en vez de soltarlo todo de golpe el día del estreno.

Si el patrón se mantiene — actualización grande más evento de recompensas repartido por semanas —, es de esperar que Americas reciba su propia versión de Sombras sobre Glast Heim (y su Mes de la Tormenta) más adelante, cuando el contenido llegue a este servidor; de momento no hay fecha confirmada para ese salto.', 'https://play.google.com/store/apps/details?id=com.gravity.rooc.android&hl=es', false, array[]::text[], '{}'::jsonb);
end
$IMPERIUM$;
