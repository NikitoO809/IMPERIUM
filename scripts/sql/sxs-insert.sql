...
declare
  ...
  guideid uuid;
begin
  select id into gid from public.games where slug = 'sword-x-staff';
  if gid is null then
    insert into public.games (slug, name, description, is_published) values ('sword-x-staff', 'Sword x Staff', $sxsq$Guías de la comunidad para Sword x Staff: primeros pasos, clases, gacha, mazmorras diarias y más. Traducidas al español desde eog.gg (sin verificar).$sxsq$, true) returning id into gid;
  end if;
  delete from public.guide_steps where guide_id in (select id from public.guides where game_id = gid);
  delete from public.guides where game_id = gid;
  insert into public.guides (game_id, slug, title, description, order_index, is_published, intro_title, intro, intro_images) values (gid, 'beginner-guide', $sxsq$Guía para principiantes de Sword x Staff$sxsq$, $sxsq$Recorrido del día 1 en Sword x Staff. Qué clase elegir, por qué explorar el mapa importa más que tu nivel, el triángulo de estadísticas, la trampa de las Stellatie del lanzamiento y tu checklist de las primeras 24 horas.$sxsq$, 1, true, $sxsq$Verdantglade es el filtro$sxsq$, $sxsq$Boltray diseña Verdantglade (el primer reino) para filtrar a aproximadamente la mitad de la base de jugadores antes de que empiece el segundo reino. Casi todos los sistemas a largo plazo que te van a importar (Premium banner, subastas de calidad dorada, economía de compañeros bestia) se abren en Cinder Ridge o más adelante. Trata Verdantglade como un tutorial largo y no comprometas gastos de Stellatie ni de Voucher en él.
...
Un slot dedicado de "Dummy" para el Skill Test en el nivel 40 también merece uno de los slots restantes. Consulta la guía DPS Dummy Test para la configuración.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/beginner-guide/', false, '{}'::text[]),
    (guideid, 4, $sxsq$La exploración del mapa es tu nivel real$sxsq$, $sxsq$Cada nivel de jugador desbloquea más del mapa. Cada área desbloqueada activa más Goddess Statues. Más Statues significan ganancias de experiencia más rápidas, que se acumulan durante los próximos dos meses del juego.
...
Temporal Crystals. Concesiones de recompensa por inactividad de dos horas. Úsalas mientras aún tengas mapa que desbloquear, o acumúlalas. Las dos estrategias son aproximadamente equivalentes en producción total de recompensa. Elige la que se ajuste a tu horario de juego. Lo único que no hay que hacer es olvidar que las tienes y dejar que se pudran en tu inventario.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/beginner-guide/', false, '{}'::text[]),
    (guideid, 5, $sxsq$El triángulo de estadísticas$sxsq$, $sxsq$Tres estadísticas de combate determinan casi toda interacción de daño. Se contrarrestan entre sí como piedra papel tijera.
...
Mastery. Physical Mastery escala el daño de habilidades físicas. Elemental Mastery escala toda habilidad elemental. La proporción de conversión es cada 40 puntos de Mastery = +1% de daño a ese tipo de daño. Toca la estadística en el menú para ver el porcentaje en vivo. Por encima de HP plano y Attack en las sub-estadísticas del equipo. Por debajo de Crit Rate, Accuracy y Block para el escalado específico de clase.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/beginner-guide/', false, '{}'::text[]),
    (guideid, 6, $sxsq$Picos de poder a los que apuntar$sxsq$, $sxsq$Tres niveles de cuenta valen más que cualquier otro en la primera semana. Planifica tus sesiones en torno a alcanzarlos antes de perseguir cualquier otra cosa.
...
Por qué importa esto. El consejo de build y las tier lists de habilidades cambian entre tiers. Un objetivo de reroll de T1 como Heavy Impact no es lo mismo que un asesino de bosses de T2; la prioridad de estadísticas de Sorcerer en T2 difiere de la prioridad de estadísticas de Sorcerer a largo plazo. Cuando leas cualquier guía de SxS en este sitio o en otro lugar, comprueba para qué tier está escrita.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/beginner-guide/', false, '{}'::text[]),
    (guideid, 8, $sxsq$Los pulls de habilidades alimentan el avance de clase$sxsq$, $sxsq$Un error F2P común es sentarse sobre cada pull de habilidad "para guardar para después." Eso funciona para Stellatie (ver abajo), pero los 10-pulls gratis de Wish Goddess Statue son diferentes. El avance de clase requiere que realmente tengas habilidades en el pool para mejorar. Moverse entre tiers de avance de clase (p. ej., 2ª clase → 3ª clase) requiere alcanzar un umbral de nivel de clase que no puedes alcanzar sin gastar las habilidades que ya has sacado.

Reclama cada 10-roll gratis diario. Gasta los rolls de mejora de habilidad en la rama de clase a la que realmente te comprometiste. Acumula Dawnium y Stellatie, no los drops de habilidad de los rolls gratis.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/beginner-guide/', false, '{}'::text[]),
    (guideid, 9, $sxsq$Sube de nivel los slots, no las habilidades individuales$sxsq$, $sxsq$Las habilidades y el equipo en Sword x Staff están en slots. El nivel se aplica al slot, no a la habilidad individual ni a la pieza de equipo. Cambiar una nueva habilidad a un slot subido de nivel hereda el nivel del slot. Esto cambia las matemáticas de mejora del juego temprano: mejora los slots sin miedo a dejar obsoleto el trabajo cuando cambies los contenidos.

Regla práctica para la semana 1: mantén tus cuatro slots de habilidad activos y cuatro slots de equipo subidos de nivel de forma más o menos pareja. Un slot maximizado con una habilidad pasable dentro hace más trabajo que cuatro slots con poco nivel con una habilidad perfecta en uno de ellos. Inclínate hacia tu slot más usado solo después de que cada slot activo esté al mismo nivel.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/beginner-guide/', false, '{}'::text[]),
    (guideid, 10, $sxsq$No gastes Stellatie en Verdantglade$sxsq$, $sxsq$Esta es la mayor trampa de todas. El orbe azul (Standard banner) saca de cada habilidad del juego y tiene un contador de pity. El orbe rosa (Premium banner) saca solo las habilidades de tu clase, tiene un pool más pequeño, y solo se desbloquea en Cinder Ridge o más adelante. Si aún no has encontrado el orbe rosa, eso es normal.
...
Skill Shard Vouchers: guárdalos para Tier 3 (Aqualis) o más tarde. Quemarlos en Tier 2 (Cinder Ridge) desperdicia el valor del voucher — las habilidades de 2ª clase quedan superadas por las habilidades de 3ª clase que vas a querer canjear de todos modos. T3 es el objetivo de quema sensato más temprano; T4 es aún más seguro.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/beginner-guide/', false, '{}'::text[]),
    (guideid, 11, $sxsq$Checklist de las primeras 24 horas$sxsq$, $sxsq$• Reclama el 10-pull diario. Sword x Staff otorga un 10-roll gratis en la Wish Goddess Statue cada día que inicies sesión. No te saltes ni un día.
...
• Haz la Fantasy Ladder diaria una vez. Sin recompensas de ranking. Solo toma las diarias y para. Si una etapa que termina en 4 o 9 te bloquea, eso es lo esperado y el Discord de EOG tiene consejos consolidados de despeje de etapas.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/beginner-guide/', false, '{}'::text[]);
  insert into public.guides (game_id, slug, title, description, order_index, is_published, intro_title, intro, intro_images) values (gid, 'companion-upgrade', $sxsq$Guía de Mejora de Companions de Sword x Staff$sxsq$, $sxsq$Emparejamiento de estadísticas por clase y prioridad de breakpoints de nivel para mejorar a los Companions. El Knight quiere Block, los DPS quieren Crit Rate, el Sage quiere Accuracy o Healing Boost. El orden universal de mejora (todos a L20, luego los que coinciden con tu clase a L50, después L70 y por último L100) es el mismo para F2P y para mega ballenas. Incluye la ley de estadísticas L20/L50/L70/L100 (el Healing Boost es exclusivo de L100) y la nota del desbloqueo de skin en L60.$sxsq$, 2, true, $sxsq$El Mismo Orden de Mejora, en Cualquier Nivel de Gasto$sxsq$, $sxsq$Los Companions de Sword x Staff reparten estadísticas en breakpoints fijos (nivel 20, 50, 70, 100), y los breakpoints son predecibles: el Nivel 70 repite la estadística del Nivel 20, y el Nivel 100 repite la estadística del Nivel 50. Empareja las estadísticas con el rasgo de tu clase y el orden de prioridad es idéntico tanto si eres F2P como si eres una mega ballena al máximo. Gastar más no cambia el orden; solo cambia la rapidez con la que lo completas.

Una guía corta y con opinión sobre qué Companions mejorar y hasta dónde. La matemática es la misma sin importar tu gasto: cada cuenta se beneficia del mismo orden de prioridad porque los desbloqueos de estadísticas de los Companions caen en breakpoints fijos que premian la subida de nivel enfocada por encima de repartir.$sxsq$, '{}'::text[]) returning id into guideid;
  insert into public.guide_steps (guide_id, order_index, title, content, source_url, is_verified, images) values
    (guideid, 1, $sxsq$Regla de Oro: Empareja las Estadísticas con tu Clase$sxsq$, $sxsq$Los Companions que priorices mejorar siempre deben coincidir con las estadísticas de tu clase activa. Prioridad de estadísticas por clase:
...
Toca el signo de exclamación de un Companion dentro del juego para confirmar su perfil exacto de estadísticas antes de comprometer materiales de mejora.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/companion-upgrade/', false, '{}'::text[]),
    (guideid, 2, $sxsq$La Ley de Estadísticas (Ofensivo vs Defensivo)$sxsq$, $sxsq$Cada Companion cae en una de dos categorías. La categoría se identifica únicamente a partir de la estadística de L20.
...
• Nivel 100: Repite la estadística de L50. El Healing Boost solo aparece en L100 -- un Companion sanador que detectaste en L50 con una estadística de sabor sanador no entregará el Healing Boost estelar hasta el 100.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/companion-upgrade/', false, '{}'::text[]),
    (guideid, 3, $sxsq$Orden Universal de Mejora$sxsq$, $sxsq$El mismo orden tanto si eres F2P, gastador ligero o una mega ballena al máximo. La única diferencia es cuánto tarda cada fase.
...
Por qué las mega ballenas siguen el mismo orden. Incluso si tu punto final es tener a todos en L100, el orden de las operaciones sigue importando porque L20 es una pequeña inversión de material a cambio de una concesión de estadística garantizada en toda la plantilla. Saltarte el suelo de L20 en el camino hacia un único principal en L100 desperdicia la contribución por Companion durante toda la subida. La propia admisión de Maple en el vídeo fuente: "De todos modos voy a llevar a todos al máximo, nivel 100", y aun así sigue exactamente este orden.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/companion-upgrade/', false, '{}'::text[]),
    (guideid, 4, $sxsq$Skins y Cosméticos$sxsq$, $sxsq$Las skins se desbloquean en L60. Sin beneficio de combate. Si un Companion que no usas activamente tiene una skin que quieres, esa es la única razón válida para subirlo más allá de su desbloqueo de estadística de L50 fuera del orden universal. En cualquier otro caso, pasa de L50 y sigue adelante.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/companion-upgrade/', false, '{}'::text[]),
    (guideid, 5, $sxsq$Regalos$sxsq$, $sxsq$Cada Companion tiene regalos preferidos. Dar el regalo correcto acelera el progreso de vínculo; dar regalos equivocados desperdicia consumibles que podrían haber ido a otro Companion.
...
• No regales a Companions que estén fuera de tu orden de mejora. Aplican las mismas reglas de prioridad: regala el suelo de L20 de forma universal y luego concéntrate en los que coinciden con tu clase.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/companion-upgrade/', false, '{}'::text[]),
    (guideid, 6, $sxsq$Errores Comunes$sxsq$, $sxsq$• Subir un Companion a L100 antes de que el resto llegue a L20. El suelo de L20 se acumula en toda la plantilla. Sube primero el suelo.
...
• Tratar la etiqueta de "lazy" como algo solo de F2P. El orden es idéntico para las ballenas. Seguirlo hace que las ballenas alcancen el punto final de L100 antes, no después.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/companion-upgrade/', false, '{}'::text[]),
    (guideid, 7, $sxsq$La Hoja de Cálculo de Maple$sxsq$, $sxsq$Maple mantiene una hoja de cálculo que clasifica a cada Companion por su tipo de L20 (ofensivo / defensivo) y su estadística de L50, para que puedas preseleccionar los objetivos de mejora que coinciden con tu clase sin tener que entrar en la página de detalle de cada Companion dentro del juego. Disponible a través de su Discord (enlace en la descripción de su vídeo de YouTube).$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/companion-upgrade/', false, '{}'::text[]);
  insert into public.guides (game_id, slug, title, description, order_index, is_published, intro_title, intro, intro_images) values (gid, 'daily-dungeons', $sxsq$Daily Dungeons de Sword x Staff$sxsq$, $sxsq$Cómo correr la Daily Dungeon de Gear y las cuatro dungeons de materiales, la regla de ruteo (te puntúan por hasta dónde llegas, no por los nodos), la escalera completa de refresco con Dawnium (F2P/ligero 2/2/2/2, medio 4/2/4/4, $1k 6/6/6/6, $3k 8/8/8/8, $5k 10/10/10/10), el banco de 6 runs y la fecha límite para desmantelar los Gear Shards viejos.$sxsq$, 3, true, $sxsq$Las Daily Dungeons Son La Tubería De Gear$sxsq$, $sxsq$Las Daily Dungeons son la fuente principal de Gear y Gear Shards. Tienes 2 runs gratis al día , más dos refrescos con Dawnium accesibles para F2P a 100 y 150 Dawnium . Las casillas de refresco adicionales más allá del run 4 se desbloquean a través de los niveles de Month Fund y de packs mensuales. Los runs no usados se acumulan hasta un tope de 6, así que puedes saltarte los días lentos y reventar en un día objetivo.

Las Daily Dungeons se dividen en dos vías: la Daily Dungeon principal de Gear (suelta la pieza de Gear en sí más Gear Shards para subir de estrellas) y cuatro dungeons de materiales (Raw Ore, Chrono Sand, alimento de Rolla y el consumible específico de tu clase). La estrategia de refresco difiere entre ambas. Esta guía cubre las dos.$sxsq$, '{}'::text[]) returning id into guideid;
  insert into public.guide_steps (guide_id, order_index, title, content, source_url, is_verified, images) values
    (guideid, 1, $sxsq$La Regla De Ruteo$sxsq$, $sxsq$Dentro de cada dungeon navegas un pequeño grafo de nodos: salas de combate, buffs, fuentes de curación y una sala de jefe al final. Los jugadores nuevos en el género tienden a escoger nodos «más seguros» (salas de curación, packs de mobs más pequeños) pensando que conserva HP para el jefe.
...
Tope accesible para F2P. 250 Dawnium por dungeon para llegar al run 4. Entre la Daily Dungeon de Gear más las cuatro dungeons de materiales, el límite superior F2P es de 1,250 Dawnium al día. Ese es el presupuesto de gasto contra el que dimensionas la escalera de refresco F2P/medio. Los niveles más altos (6/8/10 runs) requieren además suscripciones de Month Fund o packs mensuales por encima de eso.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/daily-dungeons/', false, '{}'::text[]),
    (guideid, 3, $sxsq$Escalera De Refresco De Las Dungeons De Materiales$sxsq$, $sxsq$Las cuatro dungeons de materiales corren en el mismo horario, con los mismos precios de refresco. El orden está condicionado por cuál necesita realmente tu clase actual. Cinco niveles según el gasto mensual:
...
Cómo leer la escalera. Los números son el total de runs por dungeon de materiales por día. F2P y gasto ligero comparten la misma escalera porque los refrescos F2P igual cuestan Dawnium que normalmente necesitas en otro lado. El gastador medio es el primer nivel donde tiene sentido apretar de verdad el gatillo en los dos refrescos F2P pagados más la casilla extra que te dé el pack mensual que tengas.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/daily-dungeons/', false, '{}'::text[]),
    (guideid, 4, $sxsq$Banco De Runs$sxsq$, $sxsq$Los intentos de dungeon no usados se acumulan en vez de desvanecerse. El tope del banco es 6 runs . Esto cambia el patrón de juego F2P.
...
• Útil para cambios de clase. Si sabes que viene un cambio y vas a necesitar cambiar qué dungeon de materiales priorizas, acumular te deja redirigir intentos a la dungeon correcta para la clase post-cambio.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/daily-dungeons/', false, '{}'::text[]),
    (guideid, 5, $sxsq$La Daily Dungeon De Gear Es Diferente$sxsq$, $sxsq$La Daily Dungeon de Gear suelta equipo real más Gear Shards. La prioridad de refresco en esta dungeon es más alta que en las dungeons de materiales porque:
...
Priorización F2P. Si solo puedes permitirte un refresco pagado al día entre todas las dungeons, gástalo en la Daily Dungeon de Gear, no en runs de materiales.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/daily-dungeons/', false, '{}'::text[]),
    (guideid, 6, $sxsq$Gear Shards Viejos: Desmantela, No Te Quedes Sentado$sxsq$, $sxsq$Cada nueva dungeon que se desbloquea reemplaza el pool de loot de la anterior. La economía de shards funciona con un corte duro.
...
Disparador para actuar. Cuando veas aparecer la notificación de la nueva dungeon en tu lista de misiones diarias, vende cualquier shard viejo que aún tengas dentro de las 24 horas. De lo contrario, la vía de desmantelar es la única opción que queda y la tasa de conversión es significativamente peor.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/daily-dungeons/', false, '{}'::text[]),
    (guideid, 7, $sxsq$Errores A Evitar$sxsq$, $sxsq$• No dejes que el banco de runs se desborde. El tope del banco es 6. Una vez que estás en 6 intentos acumulados, cualquier intento no usado adicional se pierde de forma permanente. Quema o refresca antes del techo.
...
• No persigas la escalera 8/8/8/8 o 10/10/10/10 a menos que también estés persiguiendo un título de temporada. Los rendimientos decrecientes pegan fuerte por encima de 6 runs. El gastador medio (4/2/4/4) limpia cualquier meta de gear realista salvo el liderato.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/daily-dungeons/', false, '{}'::text[]);
  insert into public.guides (game_id, slug, title, description, order_index, is_published, intro_title, intro, intro_images) values (gid, 'destiny-fruit', $sxsq$Guía de Destiny Fruit de Sword x Staff$sxsq$, $sxsq$Un uso común de la Destiny Fruit es la Destiny Exploration: gastarla en una ubicación concreta para tirar por una reliquia que te falta. El ejemplo en tres pasos (Relic Gallery -> lista de fuentes -> gastar en la ubicación), cuándo pasar de tirar a explorar, y el uso secundario de desbloqueos regionales (pociones de enredadera, llaves, taladros en el vendedor del reino).$sxsq$, 4, true, $sxsq$La Destiny Fruit rellena reliquias, no es una tirada al azar$sxsq$, $sxsq$Un uso común de la Destiny Fruit es la Destiny Exploration : viajar a una ubicación concreta y gastar Destiny Fruit allí para tirar por una reliquia que falta en tu Relic Gallery. El uso secundario son los desbloqueos regionales: pociones de enredadera, llaves, taladros y otros objetos en el vendedor local del reino. No hay ninguna buena razón para gastar Destiny Fruit en una ubicación aleatoria del mapa; cada gasto debería apuntar a algo que realmente necesitas.$sxsq$, '{}'::text[]) returning id into guideid;
  insert into public.guide_steps (guide_id, order_index, title, content, source_url, is_verified, images) values
    (guideid, 1, $sxsq$Ejemplo: rellenar una reliquia que falta con Destiny Exploration$sxsq$, $sxsq$Un caso de uso común de la Destiny Fruit es cerrar un hueco de la relic gallery mediante la Destiny Exploration. Los tres pasos de abajo recorren ese ejemplo usando un flujo real dentro del juego.
...
• Paso 3 — Gasta en la ubicación. Viaja al área indicada en la línea de fuente. El cuadro de confirmación muestra la ubicación y el coste en Destiny Fruit de ese intento; el coste puede variar, así que lee el cuadro antes de confirmar. Repite hasta que caiga la reliquia.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/destiny-fruit/', false, array[$sxsq$https://eog.gg/assets/games/sword-x-staff/guides/destiny-fruit-step1-gallery.webp$sxsq$, $sxsq$https://eog.gg/assets/games/sword-x-staff/guides/destiny-fruit-step2-source.webp$sxsq$, $sxsq$https://eog.gg/assets/games/sword-x-staff/guides/destiny-fruit-step3-spend.webp$sxsq$]::text[]),
    (guideid, 2, $sxsq$Cuándo pasar a Destiny Exploration$sxsq$, $sxsq$La Destiny Exploration es un rellenahuecos de reliquias, no un sustituto de tirar. La tasa de obtención de la gacha del reino es más rápida por equivalente de Destiny Fruit para la mayor parte de la galería. El punto de cambio es cuando tirar se ha ralentizado pero la galería sigue incompleta.
...
• No apuntes a reliquias que no necesitas. Una reliquia que te falta y que no forma parte de un set que pienses usar no merece la pena rellenarla. Ajusta el gasto de Destiny Exploration a tu plan de build, no al afán de completarlo todo.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/destiny-fruit/', false, '{}'::text[]),
    (guideid, 3, $sxsq$Uso secundario: desbloqueos regionales$sxsq$, $sxsq$La Destiny Fruit también se puede gastar en el vendedor local de cada reino en objetos específicos de la región. Los objetos disponibles varían según el reino, pero la lista recurrente incluye:
...
Estos son extras agradables, no la razón de ser de la Destiny Fruit. Cubre la lista de desbloqueos regionales cuando tengas fruta sobrante más allá de tu plan de Destiny Exploration, nunca antes.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/destiny-fruit/', false, '{}'::text[]),
    (guideid, 4, $sxsq$Estrategia según el nivel de gasto$sxsq$, $sxsq$La Destiny Exploration es el mismo flujo de trabajo en cualquier nivel de gasto. Lo que cambia es cuánto ha hecho ya por ti el tirar y, por tanto, lo grande que es realmente el hueco de la galería.
...
• Whale: La mayoría de las galerías se llenan solo con tiradas. La Destiny Exploration queda reservada para las últimas 1–2 ranuras rezagadas por reino, normalmente piezas de baja prioridad que la distribución de la tasa de la gacha se saltó. Usa la Destiny Fruit sobrante en desbloqueos regionales.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/destiny-fruit/', false, '{}'::text[]),
    (guideid, 5, $sxsq$Errores a evitar$sxsq$, $sxsq$• Malgastar Destiny Fruit en una ubicación aleatoria del mapa. Gastar sin un objetivo concreto de reliquia que falta quema fruta sin avanzar nada en la galería. Revisa siempre la lista de fuentes primero.
...
• Pasarte a Destiny Exploration demasiado pronto. Tirar en la gacha rellena la galería más rápido que la Destiny Exploration durante el primer ~70% de las reliquias. Tira primero, explora al final.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/destiny-fruit/', false, '{}'::text[]);
  insert into public.guides (game_id, slug, title, description, order_index, is_published, intro_title, intro, intro_images) values (gid, 'dps-dummy-test', $sxsq$Sword x Staff DPS Dummy Test$sxsq$, $sxsq$Cómo usar el Skill Test del juego (se desbloquea en el nivel 40) para comparar habilidades y loadouts. Metodología universal + una prueba de ejemplo específica de Sorcerer hecha por Keripo a nivel 40, con gráfica y conclusiones. Incluye las cuentas de Elemental Mastery (EM de tier Gold = 1.270 = +31,75% de daño según la regla de 40 EM = 1%).$sxsq$, 5, true, $sxsq$Se Desbloquea En El Nivel 40$sxsq$, $sxsq$El Skill Test del juego es la forma más rápida de comparar habilidades, equipo o loadouts completos sin gastar stamina de contenido real. Se desbloquea en el nivel 40 y te permite probar contra la configuración de equipo rival que elijas, ya sea un solo boss, un solo mob o una mezcla de distintas configuraciones variables.
...
Dos partes. Primero, cómo usar el Dummy y qué configurar antes de pulsar Start. Segundo, una prueba de ejemplo específica de Sorcerer a nivel 40 con la gráfica y las conclusiones.$sxsq$, '{}'::text[]) returning id into guideid;
  insert into public.guide_steps (guide_id, order_index, title, content, source_url, is_verified, images) values
    (guideid, 1, $sxsq$Configura Primero Tu Barra De Charms$sxsq$, $sxsq$Configura tu barra de charms antes de pulsar nada. El tier y la selección de charms cambian los resultados más que las estadísticas de daño en bruto. Barra recomendada:
...
Water to Ice y la pasiva de Wind no son excluyentes. Usa ambas junto a Elemental Mastery si tienes las tres en tier Gold.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/dps-dummy-test/', false, '{}'::text[]),
    (guideid, 2, $sxsq$Ejecutar La Prueba$sxsq$, $sxsq$• 1. Ve al Skill Test. Home › Character › Skills.
...
Consejo: guarda un loadout dedicado de "Dummy". No pruebes con tu loadout de combate real. Guarda un loadout aparte (la palabra "Test" está bloqueada, así que llámalo Dummy o similar) con una sola técnica equipada. Ejecuta cada prueba con una habilidad a la vez. Los números de daño quedan limpios y las comparaciones por habilidad son mucho más fáciles de leer que los resultados con loadouts mezclados.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/dps-dummy-test/', false, '{}'::text[]),
    (guideid, 3, $sxsq$Leer El Informe$sxsq$, $sxsq$Ejecuta cada vez tanto la configuración de solo boss como la de grupo de mobs. Distintas habilidades ganan en cada una, y un combate de mazmorra real se parece más a la configuración de mobs que al boss aislado.
...
• Lvl: Tier de rareza de la habilidad con el que se probó la fila. El ranking relativo entre habilidades tiende a mantenerse entre rarezas aunque los números absolutos escalen hacia arriba.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/dps-dummy-test/', false, '{}'::text[]),
    (guideid, 4, $sxsq$Prueba De Ejemplo A Nivel 40$sxsq$, $sxsq$Una prueba de ejemplo a nivel 40 usando el loadout de arriba. Primero la gráfica, debajo las condiciones y luego las conclusiones.

No copies estos números, copia la forma. Los valores mostrados son resultados de prueba en bruto, no daño calculado teórico. Ejecuta la prueba con tus propias estadísticas y loadout. Las habilidades de muestra están en rareza Legendary; Mythic sube los números absolutos, pero el ranking relativo entre habilidades tiende a mantenerse.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/dps-dummy-test/', false, array[$sxsq$https://eog.gg/assets/games/sword-x-staff/guides/dps-dummy-test-sample.webp$sxsq$]::text[]),
    (guideid, 5, $sxsq$Conclusiones Clave (Sorcerer)$sxsq$, $sxsq$Los rankings de abajo son para un kit de Sorcerer. La metodología se generaliza; las elecciones de habilidades concretas no. Si juegas Duelist, Knight o Sage, ejecuta tu propia prueba de Dummy en vez de copiar estos.
...
Perspectiva de Tier 2. Espera que Light tome el control en T2, impulsado por Chain Lightning y una pasiva de lightning que replica la pasiva de wind. Planifica el gasto en charms con eso en mente si estás ahorrando para el siguiente tier.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/dps-dummy-test/', false, '{}'::text[]),
    (guideid, 6, $sxsq$Advertencia: El Dummy No Tiene Elemento$sxsq$, $sxsq$El boss de prueba no tiene elemento, así que el informe de daño ignora cualquier bonus de afinidad elemental que verías contra un objetivo real. Las builds elementales se ven más débiles en el Dummy de lo que en realidad son en contenido. Vale la pena recordarlo al comparar, por ejemplo, un Fire Sorcerer contra un Duelist físico. Usa el Dummy para comparaciones relativas dentro de una sola build, no para números absolutos entre elementos.

Nota sobre Elemental Mastery vs Elemental Affinity. La Affinity (el bonus por emparejamiento) es lo que queda anulado en el Dummy. La Elemental Mastery (la estadística de daño plano) no queda anulada: aplica en el Dummy y fuera del Dummy. Así que la cifra de 1.270 EM → +31,75% de daño de arriba es lo que verás de verdad en tu informe de prueba. Los bonus de Affinity por encima de eso solo entran en juego cuando luchas contra un objetivo real con tipo elemental.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/dps-dummy-test/', false, '{}'::text[]);
  insert into public.guides (game_id, slug, title, description, order_index, is_published, intro_title, intro, intro_images) values (gid, 'food-guide', $sxsq$Guía de Comida de Sword x Staff$sxsq$, $sxsq$La comida son tres sistemas distintos. Comida de curación para dentro de las mazmorras (fuera, volver a casa es más rápido). Comida de buff temporal guardada para el combate adecuado (los buffs no caducan en el inventario). La comida permanente tiene solo tres categorías (HP, Attack, Speed) con rendimientos decrecientes por tramos (100% / 50% / 20% / 5% en los umbrales 10/30/50/51) - cómela de forma pasiva hasta ~30 en la categoría que encaje con tu clase, no la persigas más allá de eso.$sxsq$, 6, true, $sxsq$La Comida Son Tres Sistemas Distintos$sxsq$, $sxsq$La comida en Sword x Staff no es una sola función, son tres. La comida de curación te mantiene vivo dentro de las mazmorras. La comida de buff temporal añade una ventana de bonificaciones de estadísticas para un combate concreto. La comida permanente es una escalera de estadísticas a largo plazo que se acumula durante toda la temporada. La mayoría de los jugadores tratan las tres por igual y pierden valor en cada categoría. Se aplican tres reglas distintas.

Un desglose enfocado de las tres categorías de comida, qué hace en realidad cada una por debajo, y cómo gastar cada una para que la escalera de estadísticas a largo plazo no se desperdicie en curación a corto plazo.$sxsq$, '{}'::text[]) returning id into guideid;
  insert into public.guide_steps (guide_id, order_index, title, content, source_url, is_verified, images) values
    (guideid, 1, $sxsq$Comida de Curación$sxsq$, $sxsq$La categoría directa. Cada item de comida restaura una cantidad fija o porcentual de HP al consumirlo. La regla de la comida de curación trata sobre cuándo gastarla, no sobre cuál elegir.
...
• Acumula comida de curación barata. Los items de curación de nivel vendedor se amontonan en el inventario porque la mayoría de los jugadores olvidan que existen. Apila los baratos y úsalos en emergencias dentro de mazmorras.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/food-guide/', false, '{}'::text[]),
    (guideid, 2, $sxsq$Comida de Buff Temporal$sxsq$, $sxsq$Items de buff de estadísticas que duran una duración fija una vez consumidos. Bonificaciones de daño, bonificaciones de defensa, bonificaciones de daño elemental, picos de precisión. La trampa es que el temporizador del buff solo empieza cuando comes la comida, no cuando la recibes.
...
• Guarda los buffs más fuertes para tu contenido más difícil. La mayoría de la comida de buff cae mientras haces farmeo rutinario. El buff que guardas ahora es el buff que sostiene el próximo intento de jefe de gremio.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/food-guide/', false, '{}'::text[]),
    (guideid, 3, $sxsq$Comida Permanente (La Escalera a Largo Plazo)$sxsq$, $sxsq$Comer comida permanente otorga un pequeño aumento permanente de estadísticas a tu personaje. La bonificación no desaparece y no se reinicia al final de la temporada. Solo hay tres categorías de comida permanente : HP , Attack y Speed .
...
Nota sobre el coste por estadística. La comida permanente es una de las fuentes de poder más caras del juego una vez que empiezas a perseguir más allá de la banda del 100% efectivo. El coste es real, las ganancias son pequeñas, y normalmente hay mejores gastos de Dawnium / ingredientes disponibles. Trátala como un goteo pasivo en lugar de un farmeo activo.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/food-guide/', false, '{}'::text[]),
    (guideid, 4, $sxsq$Cocinar la Comida Tú Mismo$sxsq$, $sxsq$La mayoría de la comida se puede cocinar en la cocina de tu hogar. Las recetas se desbloquean a medida que progresas por las regiones. El sistema de cocina tiene algunas reglas que vale la pena conocer antes de comprometer espacios de receta.
...
• Cocina las comidas permanentes para las que tengas ingredientes, aunque todavía no necesites la estadística. La comida permanente cocinada ahora y comida después vale más que ingredientes guardados en el almacén.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/food-guide/', false, '{}'::text[]),
    (guideid, 5, $sxsq$Errores a Evitar$sxsq$, $sxsq$• Comer comida de curación en el mundo abierto. Volver a casa es más rápido y gratis.
...
• Vender ingredientes raros por Dawnium. Cocínalos primero. Los ingredientes pierden valor una vez que se desbloquean las recetas permanentes.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/food-guide/', false, '{}'::text[]),
    (guideid, 6, $sxsq$Dónde Encaja la Comida en Tu Rutina Diaria$sxsq$, $sxsq$La comida no es una actividad diaria. Es semanal. La mayoría de las cuentas obtienen el mayor valor de la comida con una sesión de cocina enfocada cada 5-7 días, no con un consumo constante.
...
• Repón comida de curación. Ten suficiente para dos días de mazmorras. Cualquier cosa más allá de eso es inventario muerto.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/food-guide/', false, '{}'::text[]);
  insert into public.guides (game_id, slug, title, description, order_index, is_published, intro_title, intro, intro_images) values (gid, 'gacha-and-pity', $sxsq$Referencia de Gacha y Pity (garantía) de Sword x Staff$sxsq$, $sxsq$Probabilidades de drop y umbrales de pity (garantía) de cada pool de tiradas de Sword x Staff. Standard banner Wish (probabilidades 1/7/22, pity 10/30/70, mileage de 200 tiradas), Premium banner Prayer (bloqueado por clase, moneda de pity Covenite), Relic banner (regla de colección del 50-70%) y Fantomon banner (SSR 0,8%, pity 80, 120 Bond Trinkets en duplicados para la evolución Mythic a nivel 108).$sxsq$, 7, true, $sxsq$El pity es la palanca del gasto$sxsq$, $sxsq$Sword x Staff tiene cuatro pools de tiradas (skills Standard, skills Premium bloqueadas por clase, Relics y Fantomons). Usan monedas distintas y umbrales de pity (garantía) distintos. Los números de pity de abajo son el presupuesto con el que dimensionas cualquier otra decisión de gacha. Si los ignoras, gastas el doble por el mismo resultado.

Una única página de referencia para cada pool de gacha de Sword x Staff. Cada sección lista las probabilidades, los umbrales de pity, la moneda y la regla de tirada recomendada por EOG. Léela de arriba abajo o salta al banner en el que estés tirando ahora mismo.$sxsq$, '{}'::text[]) returning id into guideid;
  insert into public.guide_steps (guide_id, order_index, title, content, source_url, is_verified, images) values
    (guideid, 1, $sxsq$Standard banner (Orbe azul)$sxsq$, $sxsq$Tira de todas las skills del juego. El pool más grande, la tasa de acierto individual más baja, pero el único pool que te da skills a las que aún no tienes acceso.
...
• No canjees pronto los Skill Shard Vouchers por skills T1 o T2. Los vouchers de inicio de partida se convierten en Legendaries a elegir. El inicio del juego ya te da muchas tiradas Standard gratis, así que gastarlos en skills de primer nivel desperdicia el valor del voucher, que de todas formas acaba siendo reemplazado. Guárdalos para el tercer nivel en adelante.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/gacha-and-pity/', false, '{}'::text[]),
    (guideid, 3, $sxsq$Relic banner (Por reino)$sxsq$, $sxsq$Cada reino tiene su propio relic banner. Las Relics controlan el sistema de bonus de resonancia (cuatro relics del mismo elemento activan la resonancia, que sube de nivel todas las relics no resonantes de ese mismo elemento). La regla de tirada de las relics se basa en la colección, no en la suerte.
...
Los F2P toparán con huecos de relics azules y moradas en torno al 70% de completado de la galería. Los jugadores de pago llegan al 90% incluyendo las relics Mythic. Una vez que las tiradas se ralentizan, cambia a Destiny Exploration en la ubicación indicada de la relic que falta para rellenar el resto: mira la guía de Destiny Fruit para el ejemplo de tres pasos.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/gacha-and-pity/', false, '{}'::text[]),
    (guideid, 4, $sxsq$Fantomon banner$sxsq$, $sxsq$Los Fantomons se desbloquean al nivel 50 y usan una moneda distinta de las tiradas de skills. La regla de evolución Mythic es el número más importante de este banner.
...
Trampa habitual con los Mythic. Los jugadores gastan 60 Bond Trinkets en Aegiswing pensando que ya está, llegan al nivel 100 y entonces se dan cuenta de que evolucionar a 108 necesita otros 120 Bond Trinkets en duplicados (2 copias más, 60 cada una). Si no puedes permitirte los 120 Bond Trinkets completos en duplicados para el rol que de verdad juegas, no compres un Mythic. Mientras tanto, acumula Fantomons SSR y guarda trinkets.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/gacha-and-pity/', false, '{}'::text[]),
    (guideid, 5, $sxsq$Orden de tirada: qué tirar primero$sxsq$, $sxsq$Una prioridad de gasto limpia si tienes moneda en varios pools a la vez:
...
• Bond Trinkets: Fantomon banner. Cae de eventos temáticos de Fantomon, cadenas de login diario y hitos del collab de KonoSuba.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/gacha-and-pity/', false, '{}'::text[]);
  insert into public.guides (game_id, slug, title, description, order_index, is_published, intro_title, intro, intro_images) values (gid, 'grand-treasure-hunt', $sxsq$Sword x Staff: Grand Treasure Hunt$sxsq$, $sxsq$Cómo gastar Aurodrasil Energy en el Grand Treasure Hunt para sacarle el máximo valor como F2P. Cadencias de ahorrar-y-gastar, los tres principios absolutos de QY Maple (extremo izquierdo en el Floor 5, la Energy se acumula entre ciclos, las reliquias únicas son obligatorias), prioridades de recompensa de los niveles 1 a 5, las trampas del L4 que debes saltarte, el muro de Loong Haven para F2P y la rotación de fases actual de Cinder Ridge / Aqualis.$sxsq$, 8, true, $sxsq$La mayor trampa para F2P en cualquier evento$sxsq$, $sxsq$El Grand Treasure Hunt es el evento rotativo donde gastas Aurodrasil Energy en cinco niveles de recompensa. La trampa: la mayoría de los jugadores gasta cada semana creyendo que la cadencia coincide con el reinicio del evento. No es así. Gastar semanalmente deja recompensas del Nivel 5 sin reclamar porque la Aurodrasil Energy se recarga más rápido de lo que conviene recoger las recompensas de los niveles altos. Existen dos cadencias correctas, y ambas esperan varias semanas por gasto.

El Grand Treasure Hunt es uno de los eventos con mayor rentabilidad del juego para cuentas F2P porque el nivel de recompensa del Nivel 5 está detrás de un muro de moneda que castiga el gasto semanal. Si te dosificas correctamente, te llevas varios objetos del Nivel 5 por ciclo. Si te dosificas mal, malgastas tu Aurodrasil Energy en recompensas de L1-L2 que nunca se acumulan.$sxsq$, '{}'::text[]) returning id into guideid;
  insert into public.guide_steps (guide_id, order_index, title, content, source_url, is_verified, images) values
    (guideid, 1, $sxsq$Los tres principios absolutos de Maple$sxsq$, $sxsq$Maple resumió el evento en tres reglas. El resto de esta guía son las cuentas + los detalles por rotación que las demuestran.
...
• 3. Reliquias únicas: los F2P que aún no han llegado a Loong Haven (Season 2) deberían saltarse el 1.º y el 3.º Grand Treasure Hunt, pero coger sin falta las reliquias únicas del 2.º y el 5.º. Las ascensiones de la Lucky Statue de la Phase 6 son recomendables pero no obligatorias; eso es una decisión de inversión personal. Una vez que llegues a Loong Haven, sigue la Regla 2 para canjear la reliquia única en cada ciclo.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/grand-treasure-hunt/', false, '{}'::text[]),
    (guideid, 2, $sxsq$Cómo elegir recompensas en los primeros cuatro niveles$sxsq$, $sxsq$Los tesoros de L1-L4 se dividen en dos categorías. No hay una elección correcta o incorrecta entre ellas, solo preferencia según lo que tu cuenta necesite.
...
• Si no te gustan las tasas de drop con poco RNG → elige Skills directamente. Progreso determinista en la skill de clase que estés construyendo, sin suerte del pool de reliquias de por medio.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/grand-treasure-hunt/', false, '{}'::text[]),
    (guideid, 3, $sxsq$La rotación de este ciclo (Cinder Ridge / Aqualis)$sxsq$, $sxsq$El nuevo ciclo empieza en el reinicio de mañana y se extiende por seis fases a lo largo de las semanas de Cinder Ridge y Aqualis. Dos fases dan Lucky Statue y una da Primal Gem; esas son las tres elecciones en torno a las que se construye la cadencia de ahorrar-y-gastar de más abajo.
...
Más allá de este ciclo. La reliquia única del Floor 5 cambia en cada Hunt. Para planificar con antelación los ciclos posteriores a este, consulta la hoja de cálculo de rotación de recompensas de QY Maple. Mapea la reliquia única + los efectos de stats de cada Hunt para que puedas decidir qué Hunts saltarte y a través de cuáles ahorrar.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/grand-treasure-hunt/', false, '{}'::text[]),
    (guideid, 4, $sxsq$Prioridades de recompensa por nivel$sxsq$, $sxsq$Cinco niveles de recompensa. Cada ciclo, la recompensa del L5 rota. Los niveles L1-L4 se mantienen relativamente estables, así que las prioridades de más abajo aplican en la mayoría de los ciclos.
...
• Level 5: Rota. Prioridad de casillas: Izquierda > Extremo derecho > Centro. La Izquierda es la reliquia única (cógela siempre); el Extremo derecho es la elección secundaria; el Centro es la más baja. Rotaciones destacadas: Lucky Statue — Relic pasiva que escala del 10% al 60% de probabilidad de duplicar los drops de los cofres de Dungeon a medida que acumulas copias. Primal Gem — aumento del 10% al 60% en la obtención de Gem en todas las fuentes excepto packs y casa de comercio. Coge ambas siempre que roten. La Lucky Statue vuelve cada ~1,5 meses, así que aprovecha cada ventana de Phase en la que aparezca.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/grand-treasure-hunt/', false, '{}'::text[]),
    (guideid, 5, $sxsq$Cadencia de gasto F2P: dos opciones$sxsq$, $sxsq$La Aurodrasil Energy se recarga aproximadamente hasta el tope cada semana. Gastar semanalmente significa que no puedes permitirte la ventana de recompensa del L5. Funcionan dos patrones.
...
El muro de Loong Haven. La cadencia de arriba asume que aún estás en Verdantglade o Cinder Ridge. Una vez que llegues a Loong Haven (Season 2), la curva de ingresos de Aurodrasil se empina lo suficiente como para que los F2P puedan canjear de forma estable la reliquia única en cada ciclo con la misma cadencia sin packs de 500. Antes de Loong Haven, los F2P deben esperar saltarse Hunts alternos; después, cada ciclo está al alcance.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/grand-treasure-hunt/', false, '{}'::text[]),
    (guideid, 6, $sxsq$Errores comunes$sxsq$, $sxsq$• Gastar cualquier Aurodrasil Energy en una semana en la que no puedes permitirte el L5. Si tu reserva no va a alcanzar los ~3,240 Energy para el final de la semana, sáltate el evento entero. Cada clic de L1-L4 en una semana floja aleja un futuro L5 de tu alcance.
...
• Saltarte el ciclo entero cuando sí puedes permitirte el L5. Aunque la rotación del L5 parezca floja, la cadencia de 2 semanas aun así se lleva Legendary Auroral Badges o Bond Trinkets de L4 más relleno de L1-L3. No te quedes en cero si puedes superar el mínimo de 3,240 Energy.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/grand-treasure-hunt/', false, '{}'::text[]),
    (guideid, 7, $sxsq$Dónde encaja esto en el orden de gasto$sxsq$, $sxsq$El Grand Treasure Hunt va por detrás del bucle diario principal. Ordénalo de la siguiente manera:
...
El Grand Treasure Hunt es el evento que más recompensa la dosificación correcta. Si solo aprendes una regla de cadencia de eventos, que sea esta.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/grand-treasure-hunt/', false, '{}'::text[]);
  insert into public.guides (game_id, slug, title, description, order_index, is_published, intro_title, intro, intro_images) values (gid, 'important-tips', $sxsq$Consejos Importantes de Sword x Staff$sxsq$, $sxsq$Más allá de la Guía para Principiantes. Viabilidad de clases, mejoras del carro, reglas de inversión en Fantomons, resonancia de relics, NPC Misterioso + Primal Forge, estrategia de tickets de Arena, refresco de tienda, orden de gasto y trampas del juego a largo plazo.$sxsq$, 9, true, $sxsq$Más Allá de la Guía para Principiantes$sxsq$, $sxsq$Consejos Importantes retoma donde lo deja la Guía para Principiantes. Decisiones de build específicas por clase, prioridades de carro y relics, la regla del NPC Misterioso, la cadencia de refresco de tienda, la estrategia de Arena y el orden de gasto en la tienda de lanzamiento. Léelo de principio a fin, o salta a la sección en la que esté tu cuenta.$sxsq$, '{}'::text[]) returning id into guideid;
  insert into public.guide_steps (guide_id, order_index, title, content, source_url, is_verified, images) values
    (guideid, 1, $sxsq$Decisiones de Clase y Build$sxsq$, $sxsq$• Sage solo tiene un build viable: Dark . El Sorcerer Light es una elección solo para PvP. Los builds de Summoner y Healer no son viables en el parche global actual.
...
• Un jugador F2P no puede permitirse dos elementos. Las relics solo otorgan un 10-15% de bonus de elemento, así que dividir la afinidad cuesta un daño serio y ralentiza tu enfoque en subir de nivel las skills. Elige un elemento y termínalo.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/important-tips/', false, '{}'::text[]),
    (guideid, 2, $sxsq$Mejoras del Carro$sxsq$, $sxsq$El carro produce recursos que se solapan con los de las mazmorras, además de equipo y alimento para bestias. Prioridad de mejora por nivel de producción:
...
Si tienes objetivos específicos de clase (por ejemplo, sabes que te vas a comprometer con Sorcerer y necesitas más alimento de Fantomon de tipo ataque), inclina ese 20-30% enfocado hacia el tipo de alimento que corresponda.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/important-tips/', false, '{}'::text[]),
    (guideid, 3, $sxsq$Reglas de Inversión en Fantomons$sxsq$, $sxsq$Los Fantomons se desbloquean al nivel 50 y son el mayor pico de poder fuera del equipo en Cinder Ridge. La trampa es tratarlos como un único conjunto. Tres reglas deciden si tu inversión se acumula o se desperdicia.
...
El desglose completo, incluyendo qué mazmorra priorizar por clase y las cuentas de gasto en refrescos de Dawnium, está en la guía de Mazmorras Diarias .$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/important-tips/', false, '{}'::text[]),
    (guideid, 6, $sxsq$Horario de Refresco de Tienda$sxsq$, $sxsq$• Antes de que abra Aqualis: F2P refresca una vez al día, vacía la tienda.
...
• Ballenas: escala el número de refrescos a tu total de material de Mystery Realm. Cuanto mayor sea el stock, más refrescos.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/important-tips/', false, '{}'::text[]),
    (guideid, 7, $sxsq$NPC Misterioso: Solo Primal Forge$sxsq$, $sxsq$El día después de que termine la Chaos Invasion, aparece un NPC Misterioso en tu Home. Puedes gastar Chaos Crystals en su tienda. SOLO compra el Primal Forge. Nada más. Esta regla se aplica a todos los jugadores sin importar su nivel de gasto.
...
Por qué es tan estricto. El Primal Forge es el único artículo de la tienda de Chaos que se acumula a lo largo de los reinos. Cualquier otra compra es reemplazada o queda obsoleta por las recompensas de Cinder Ridge, así que gastar en ellas hace retroceder tu cuenta.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/important-tips/', false, '{}'::text[]),
    (guideid, 8, $sxsq$Estrategia de Tickets de Arena$sxsq$, $sxsq$El refresco de PvP es semanal. La semana reinicia la escalada, lo que permite que los empujes de principio de semana agarren rangos altos antes de que los rosters de nivel ballena fijen la cima en su sitio.
...
• Comprar tickets extra en un solo día cuesta más Dawnium por ticket. El máximo beneficio significa comprar casi cero tickets después de la semana 1.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/important-tips/', false, '{}'::text[]),
    (guideid, 9, $sxsq$Orden de Gasto Si Abres la Cartera$sxsq$, $sxsq$Del mejor valor al peor valor en toda la tienda de lanzamiento.
...
Vouchers vs puntos VIP. Los vouchers se convierten directamente en valor equivalente a dinero. Los puntos VIP solo se acreditan cuando realmente gastas, así que no acumules vouchers esperando que el track VIP los alcance.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/important-tips/', false, '{}'::text[]),
    (guideid, 10, $sxsq$Trampas del Juego a Largo Plazo$sxsq$, $sxsq$• No hagas reroll. Los nombres son únicos y no hay ningún beneficio de reroll integrado en el juego.
...
• El cariño se topa en 1000 por semana en las invocaciones. El exceso se sigue acumulando como corazones de perfil, pero no puedes arrastrar el cariño sobrante a la reclamación de la semana siguiente.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/important-tips/', false, '{}'::text[]);
  insert into public.guides (game_id, slug, title, description, order_index, is_published, intro_title, intro, intro_images) values (gid, 'reroll-guide', $sxsq$Guía de Reroll de Sword x Staff$sxsq$, $sxsq$Cuándo hacer reroll, cuándo no, y qué skills priorizar en las aperturas de Warrior y Mage. Por qué quedar atado a un servidor suele pesar más que la ventaja, el bucle de reroll de 15-20 minutos, objetivos concretos (Heavy Impact, Water Assault) y las condiciones para parar.$sxsq$, 10, true, $sxsq$Lee Esto Antes De Hacer Reroll$sxsq$, $sxsq$Sword x Staff tiene capacidad de servidor limitada. Hacer reroll implica abandonar tu servidor inicial, y una vez que un servidor llega a su tope ya no puedes unirte a él más tarde. Si tus amigos o tu guild ya están en un servidor, hacer reroll puede dejarte fuera de jugar con ellos de forma permanente. La decisión no va solo de pulls. Lee la sección ¿Deberías hacer reroll? antes de abrir una cuenta nueva.
...
Un árbol de decisión enfocado en si hacer reroll y qué priorizar si te decides. La verdad que la mayoría de guías de reroll esconden: en Sword x Staff la curva para alcanzar al resto es corta y quedar atado al servidor es permanente, así que las cuentas rara vez favorecen el reroll a menos que tengas un objetivo muy concreto y ningún compromiso social con el servidor de lanzamiento.$sxsq$, '{}'::text[]) returning id into guideid;
  insert into public.guide_steps (guide_id, order_index, title, content, source_url, is_verified, images) values
    (guideid, 1, $sxsq$¿Deberías Hacer Reroll?$sxsq$, $sxsq$Tres preguntas lo deciden. Respóndelas con honestidad antes de abrir una cuenta nueva.
...
La ventana para alcanzar al resto es corta. Los que no hacen reroll reciben las recompensas de login de lanzamiento, los pulls de la colaboración con KonoSuba repartidos en hitos, y los 13 códigos de canje activos dentro de su primera semana. Después del día 7-10 la diferencia entre una cuenta con reroll y una cuenta normal es lo bastante pequeña como para que el coste social del reroll suela pesar más que el beneficio.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/reroll-guide/', false, '{}'::text[]),
    (guideid, 2, $sxsq$Cómo Funciona Una Vuelta De Reroll$sxsq$, $sxsq$Si decides hacer reroll, el bucle es corto. Cuenta con 15-20 minutos por vuelta.
...
Vincula tu cuenta final. Una vez que tengas los pulls que querías, vincúlala a un correo o cuenta social permanente de inmediato. Las cuentas solo de invitado pueden borrarse al reinstalar la app o al cambiar de dispositivo.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/reroll-guide/', false, '{}'::text[]),
    (guideid, 3, $sxsq$Objetivos De Reroll Para Mage$sxsq$, $sxsq$Mage se abre hacia Sorcerer o Sage en el segundo avance de clase (Lv.44, en Cinder Ridge). La lista de reroll de lanzamiento asume que vas a ir Sorcerer, que es el camino más amigable para F2P. Los objetivos de Sage se solapan mucho, así que esta lista sigue siendo válida si cambias más tarde.
...
Qué ignorar en la tirada de Mage. Los skills de objetivo único del lado Mage (Fireball, Frost Spear) son provisionales durante las primeras semanas. Los reemplaza el segundo job tier. No hagas reroll por ellos.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/reroll-guide/', false, '{}'::text[]),
    (guideid, 4, $sxsq$Objetivos De Reroll Para Warrior$sxsq$, $sxsq$Warrior se abre hacia Duelist o Knight. Los objetivos de abajo asumen Duelist, que es la rama más popular y la opción de DPS con mayor techo.
...
Qué ignorar en la tirada de Warrior. Los skills de utilidad orientados a Knight (Guard Defense, Charge Assault) están bien pero no son de nivel reroll. Se vuelven útiles si te comprometes con Knight, pero el pool de la tirada de Warrior se aprovecha mejor persiguiendo skills de DPS del lado Duelist.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/reroll-guide/', false, '{}'::text[]),
    (guideid, 5, $sxsq$Condiciones Para Parar$sxsq$, $sxsq$Dos condiciones por las que vale la pena parar. Tirar buscando la apertura perfecta desperdicia horas que cuentan en contra de tu progresión.
...
No persigas un Legendary que no necesitas. El pity del standard banner es de 70 pulls para un Legendary garantizado, pero solo consigues unos 55 pulls durante la ventana de reroll. Una sola cuenta con mala suerte no justifica otro ciclo de reinicio de 20 minutos.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/reroll-guide/', false, '{}'::text[]),
    (guideid, 6, $sxsq$Qué Hacer Si No Deberías Hacer Reroll$sxsq$, $sxsq$Si recorriste el árbol de decisión y la respuesta fue "no hagas reroll", esa es la opción por defecto fuerte. El tiempo que gastarías en el reroll está mejor invertido en otra parte:
...
• Únete a una guild al nivel 15. Los drops del Guild Boss incluyen Skill Shard Vouchers, que es el camino de adquisición de skills de mayor calidad en el juego temprano fuera de Cinder Ridge.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/reroll-guide/', false, '{}'::text[]);
  insert into public.guides (game_id, slug, title, description, order_index, is_published, intro_title, intro, intro_images) values (gid, 'void-rifts', $sxsq$Sword x Staff Void Rifts$sxsq$, $sxsq$Evento quincenal de los domingos que rota con Chaos Invasion. 10 intentos dentro de las 24 horas tras su aparición; luego desaparece hasta su siguiente rotación. De 1 a 5 pisos de progresión por suerte por partida para conseguir tiradas de relics hasta Mythic. El juego en grupo escala las recompensas para quienes no son whales.$sxsq$, 11, true, $sxsq$Evento quincenal de los domingos, ventana de 24 horas$sxsq$, $sxsq$Void Rifts aparece cada dos domingos y rota con Chaos Invasion: un domingo toca Void Rifts y el siguiente Chaos Invasion. Tienes 10 intentos dentro de las 24 horas tras su aparición; cuando se cierra la ventana, el evento desaparece hasta su siguiente turno de rotación. Los intentos no se acumulan ni se trasladan entre rotaciones. Gástalos los 10 ese día o los pierdes.

Guía compacta para un evento compacto. Lee el resumen, despacha la partida y sigue adelante.$sxsq$, '{}'::text[]) returning id into guideid;
  insert into public.guide_steps (guide_id, order_index, title, content, source_url, is_verified, images) values
    (guideid, 1, $sxsq$Cómo funciona una partida$sxsq$, $sxsq$• Encuentra un rift. Los marcadores aparecen por el mapa del mundo abierto de cada región. La elección de la región no afecta a las recompensas. Los rifts en disputa (con otro jugador ya dentro) te bloquean el acceso: ve hacia el siguiente marcador.
...
• Sal con tiradas de relics. Las tiradas de rareza son independientes en cada tirada, así que una sola partida puede mezclar Normal / Epic / Legendary / Mythic. Las recompensas de moneda escalan según cuántos pisos hayas limpiado.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/void-rifts/', false, '{}'::text[]),
    (guideid, 2, $sxsq$Consejos de grupo y combate$sxsq$, $sxsq$• Composición del grupo: 1 healer + 1 frontliner resistente + 2 DPS. Recluta antes de entrar a la cola en lugar de forzar el primer intento a la fuerza.
...
• El solitario está bien para los whales que pueden limpiar a fondo pisos altos por su cuenta. Para todos los demás, el bono de grupo compensa con creces el coste de coordinarse.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/void-rifts/', false, '{}'::text[]),
    (guideid, 3, $sxsq$Checklist del día del evento$sxsq$, $sxsq$• Conéctate el domingo en que aparece. Comprueba la rotación frente al domingo anterior: si la semana pasada fue Chaos Invasion, esta semana es Void Rifts.
...
• Salta de inmediato los rifts en disputa. Ve al siguiente marcador en lugar de esperar.$sxsq$, 'https://eog.gg/games/sword-x-staff/guides/void-rifts/', false, '{}'::text[]);
end
$do$;